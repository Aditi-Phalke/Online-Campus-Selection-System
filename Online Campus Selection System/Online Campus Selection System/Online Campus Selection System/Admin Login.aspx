<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Admin Login.aspx.cs" Inherits="Online_Campus_Selection_System.Admin_Login" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div>
    <table class="auto-style23">
        <tr>
            <td class="text-center" style="height: 20px; width: 337px"></td>
            <td class="text-center" style="height: 20px; font-size: x-large; width: 497px">ADMIN LOGIN</td>
        ...
        <tr>
         ...
         <tr>
            ...
            <td class="text-center" style="height: 26px">
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Registration.aspx" style="font-size: medium">Create New Admin Here</asp:HyperLink>
             </td>
        </tr>
    </table>
</div>
